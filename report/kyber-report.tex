...
\usepackage{xcolor}
\usepackage{enumitem}
\usepackage{float}          % [H] specifier: pin a table exactly where it is written
...
service stack with segmented users and servers, dual-stack IPv4 and IPv6 throughout, a user directory, a TLS-protected REST service backed by a database, monitoring,
